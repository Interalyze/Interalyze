...
class BERTPersonalityAnalyzer:
    """
    A class to load and use the Minej/bert-base-personality model to analyze Big Five personality traits.
    """
    ...
    def __init__(self):
        ...
        """
        self.model = AutoModelForSequenceClassification.from_pretrained("Minej/bert-base-personality")
        self.tokenizer = AutoTokenizer.from_pretrained("Minej/bert-base-personality")
